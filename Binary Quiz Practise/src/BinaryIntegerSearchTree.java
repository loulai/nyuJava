...
public class BinaryIntegerSearchTree<T extends Comparable<T>> 
             implements BSTInterface<T>
{
  protected BSTIntegerNode root;      // reference to the root of this BST
  ...
  public  BinaryIntegerSearchTree()
  ...
  private int recSize(BSTIntegerNode tree)
  ...
  // Returns the number of elements in this BST.
  {
    ...
    if (root != null)
    {
      LinkedStack<BSTIntegerNode> hold = new LinkedStack<BSTIntegerNode>();
      BSTNode<T> currNode;
      hold.push(root);
      while (!hold.isEmpty())
      {
