...
//		System.out.println("Can list 'b' be terminated? " + terminates(a3)); //testing results if you want
	...
	static public <T> boolean terminates(LLNode<T> list) {
		 ...
		 * The 'fast' reference is incremented (cusing getLink()) twice as fast as the 'slow' reference.
