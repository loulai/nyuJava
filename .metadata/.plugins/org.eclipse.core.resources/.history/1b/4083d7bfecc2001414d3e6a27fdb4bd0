...
public class Sieve {
	 ...
	 */
	public static void primesTo(Integer lastNum) throws IllegalArgumentException{
		
		if(lastNum == 2){
			System.out.println("2");
			return;
		} else if (lastNum < 2){
			throw new IllegalArgumentException ("=== The upper bound can't be smaller than 2. Try again. ====");
		}
