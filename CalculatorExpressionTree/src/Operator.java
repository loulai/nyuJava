//used for the converter class, in order to compare the precedence of operators
...
public class Operator {
	...
	public boolean isEqualTo(String topOfStack){
		...
		if((currentOperator + " ").equals(topOfStack)) {
			...
			if(currentOperator.equals("^")){ //at this point, ^ is filtered out if its equal. So this must be false.
